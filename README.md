...
Atualmente cursando o 2º semestre de Ciência da Computação na UNICID. Tenho interesse em resolver problemas por meio da tecnologia, com foco em **desenvolvimento de software** e **banco de dados**.

* **Habilidades Técnicas:** Python, HTML5, CSS3, MySQL, C++, Git.
* **Habilidades Socioemocionais:** Proatividade, trabalho em equipe e pensamento lógico.
* **Momento atual:** Construindo meu portfólio com projetos práticos e buscando minha primeira oportunidade de estágio na área de tecnologia.
...
![Machine Learning](https://img.shields.io/badge/Machine%20Learning-Estudando-orange?style=for-the-badge&logo=tensorflow&logoColor=white)
...
| Projeto | Descrição | Link |
| :--- | :--- | :---: |
| Projeto Bubble — Aplicativo de Delivery | Descrição | [Ver Projeto](https://github.com/joaopaulo1211/portfolio-joao-paulo-da-silva-pereira/blob/main/engenhariadeprompt%20e%20aplica%C3%A7%C3%B5es%20em%20ia/projeto%20%20bubble%20%20aplicativo%20%20de%20%20delivery/README.md) |
